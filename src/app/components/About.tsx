...
export default function About() {
  return (
    <div className="z-10 flex mb-10 flex-col gap-y-10 lg:gap-y-0 lg:flex-row items-center lg:justify-between w-[90vw] lg:w-[1200px] 2xl:w-[1200px]">
      <div className="w-[92vw] sm:w-[90vw] lg:w-[650px] 2xl:w-[650px] bg-[#212428] rounded-lg p-6 sm:p-10">
        ...
        <div className="text-lg mt-4 ml-1 font-semibold text-[#23C7AC]">
          I have 2 years+ of exprience with Android & Flutter development.
        </div>
      </div>
      <div className="h-full w-[92vw] sm:w-[90vw] lg:w-[510px] 2xl:w-[510px] bg-[#212428] rounded-lg p-6 sm:p-10">
