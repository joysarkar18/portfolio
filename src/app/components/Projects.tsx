...
export default function Projects() {
  return (
    <div className="h-full w-[1200px] 2xl:w-[1400px] bg-[#212428] rounded-lg mb-10 flex flex-col justify-start items-center p-10">
      ...
      <div className="grid grid-cols-3 gap-x-16 2xl:gap-x-20 gap-y-28 mt-28">
        <ProjectCard
