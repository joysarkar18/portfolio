...
export default function MySkills() {
  return (
    <div className="w-[70vw] flex justify-between mb-10">
      <div className="w-[30.5vw] bg-[#212428] rounded-lg py-6 px-6">
        <Spline scene="https://prod.spline.design/KABHapiENlB9SSsm/scene.splinecode" />
      </div>
      <div className="w-[37.5vw] bg-[#212428] rounded-lg p-10">
