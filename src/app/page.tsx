...
export default function Home() {
  return (
    <div className="w-full bg-[#080716] flex flex-col justify-center items-center">
      <nav className="h-20 w-[1400px] flex justify-end items-center gap-6">
      ...
      <MySkills></MySkills>
      <Projects></Projects>
      <div className="h-full w-[1400px] bg-[#212428] rounded-lg mb-20 flex flex-col justify-start items-center p-10">
